            ...
            <div className="modal-body">
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ background: 'var(--surface-container-low)', padding: 12, borderRadius: 8, fontSize: 11, fontFamily: 'monospace', overflowX: 'auto', border: '1px solid var(--ghost-border)' }}>
                  nama,email,no_hp,posisi,role,secondary_roles,team_type,nip,nik,tempat_lahir,tanggal_lahir,jenis_kelamin,status_pernikahan,alamat,tanggal_masuk,bank_name,rekening_nomor,rekening_nama,gaji_pokok,tunjangan,fee_closing,fee_lead,bonus_target,bonus_nominal
                </div>
                <button 
                  ...
                  onClick={() => {
                    const headers = [
                      "nama", "nama_panggilan", "email", "no_hp", "posisi", "role", "secondary_roles", "team_type",
                    ...
                    const csvContent = headers.join(",") + "\n" + 
                      "Roza Lailia,Roza,roza@email.com,08123456789,Talent Live,Staff,pengajar,LIVE,REGULAR,SP-00001,1234567890,Jakarta,1995-01-01,Perempuan,Lajang,Jl. Merdeka No. 1,2024-01-01,BCA,12345678,Roza Lailia,3500000,500000,50000,1000,10,100000";
