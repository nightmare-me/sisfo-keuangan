  ...
  try {
    ...
    for (const rawItem of data) {
      ...
      const item = {
        ...
        rekening_nomor: fixExcelNumber(getVal(['rekening_nomor', 'no_rekening', 'nomor rekening', 'rekeningnomor'])),
        rekening_nama: cleanStr(getVal(['rekening_nama', 'pemilik_rekening', 'nama pemilik', 'rekeningnama'])),
